...
#SBATCH --profile=all
#SBATCH --job-name=base_thresh
#SBATCH --output="/scratch/dberger/dynamic_loss/slurm_logs/base_thresholded__%A_%a_%j.out"
#SBATCH --array=0-149
...
PY_SCRIPT="$(readlink -f "$PY_SCRIPTS/base_train_threshold.py")"
